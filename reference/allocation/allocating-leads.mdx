...
The allocation node assigns leads and manages workload distribution. Allocation happens by default in a 'round-robin' mode, spreading assignments equally among available sales members.
...
![Creating a capacity model mapping](/images/allocating-leads-5.png)
...
- The allocation node can be configured in failure mode to retry to continue to attempt allocating the lead to the member.
