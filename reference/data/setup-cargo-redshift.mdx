---
title: "Set up the Redshift integration on Cargo"
...
1. **Verify Cluster Connectivity**
   ...
   - For network configuration help, refer to the [<u>AWS Redshift documentation</u>](https://docs.aws.amazon.com/redshift/latest/gsg/rs-gsg-authorize-cluster-access.html)
