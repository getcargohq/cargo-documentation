...
description: "Learn how to track and analyze activities data from Cargo tools and plays using SQL queries"
---

Activities data provides comprehensive insights into your workspace's orchestration activities, including workflow executions, node operations, and segment transitions. This data is automatically captured and stored in your data warehouse, allowing you to monitor performance, debug issues, and analyze usage patterns.

## Getting started

1. **Access the sandbox**: Navigate to **System of records** → **Sandbox** tab at `https://app.getcargo.io/workspaces/<workspace_uuid>/settings/sor`
2. **Write your query**: Enter your SQL query in the query input field using the appropriate syntax for your database (BigQuery or Snowflake)
3. **Replace placeholders**: Update `[DATASET]`, `[CONNECTOR_SLUG]`, and workflow UUIDs with your actual values
4. **Execute and analyze**: Click the **Query** button to run your query and view results in the results area below
...
You can write SQL queries to analyze activities data directly from the sandbox area of your Cargo workspace. Navigate to **System of records** → **Sandbox** tab at `https://app.getcargo.io/workspaces/<workspace_uuid>/settings/sor` to access the query interface. This allows you to explore your orchestration patterns and troubleshoot issues in real-time.
...
This approach gives you real-time visibility into how your tools and plays are performing, helping you identify bottlenecks, errors, and optimization opportunities.