...
<CardGroup cols={3}>
  <Card title="Members" icon="users">
    Your sales team imported from connected CRMs, enriched with custom metadata like languages and specializations.
  </Card>
  <Card title="Territories" icon="map">
    Logical groupings of members by region, vertical, or segment—each with optional fallback assignments.
  </Card>
  <Card title="Capacities" icon="gauge-high">
    Workload limits that ensure fair distribution and prevent rep overload.
  </Card>
</CardGroup>
