...
Search and retrieve records from any data model or dataset in your workspace. This node queries your data and returns matching records that you can use in subsequent steps of your play.
