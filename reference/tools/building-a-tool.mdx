...
---insert screenshot of a tool's inputs---
...
---insert screenshot of a node's execution logic---
...
Once a tool starts running, you can view the logs of the records which were processed through it. In the top bar of the tool editor, click on records to see the full history of the tool's runs.

Within the records view, you can see the progress of each of the tool's runs, including running, completed, and failed runs on each of the nodes. You can click on any of the expand buttons on the rows of the records table to see more details about that specific run.

In addition to records, you can view metrics for each tool to see how it's performing over multiple versions and time. Click on the tool's metrics to see consolidated metrics for failures and successful runs each of its nodes.