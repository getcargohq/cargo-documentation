...
<CardGroup cols={2}>
  <Card title="Set up alerts early" icon="bell">
    Don't wait for users to report issues. Configure alerts before deploying tools to production.
  </Card>
  <Card title="Review metrics weekly" icon="calendar-week">
    Check your tools' metrics regularly to spot trends before they become problems.
  </Card>
  <Card title="Track error patterns" icon="magnifying-glass-chart">
    When you see repeated failures, investigate and fix the root cause—don't just retry.
  </Card>
  <Card title="Version your changes" icon="code-branch">
    Use tool versions to correlate performance changes with code changes.
  </Card>
</CardGroup>