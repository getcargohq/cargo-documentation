...
{/*ARCADE EMBED START*/}<div style={{position: "relative", paddingBottom: "calc(62.5% + 41px)", height: 0, width: "100%"}}><iframe src="https://demo.arcade.software/vQRYqt1RJcP8I2doPDQa?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true" title="Step 2 - Create a Named Credential in Salesforce" frameBorder="0" loading="lazy" webkitAllowFullScreen mozAllowFullScreen allowFullScreen allow="clipboard-write" style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}} ></iframe></div>{/*ARCADE EMBED END*/}
