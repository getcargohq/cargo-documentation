...
![Step 4 - Map Fields in a Salesforce Flow Assignment Step (2).gif](/images/Step4-MapFieldsinaSalesforceFlowAssignmentStep\(2\).gif)
...
![Step 6 - Add a Custom Flow Button to an Account in Salesforce (3).gif](/images/Step6-AddaCustomFlowButtontoanAccountinSalesforce\(3\).gif)