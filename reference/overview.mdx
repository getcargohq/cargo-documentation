...
- **[Data Models](/reference/data/system-of-record)** provide the structured foundation for your workspace, organizing information and powering automations. They can connect to your own data warehouse or use Cargo’s built-in storage.
- **[Lead Allocation](/reference/allocation)** are specialized features for handling workload distribution and territory management for revenue operations teams.

Use the Reference section to find detailed explanations, implementation guides, and best practices for each concept. Each page is organized by topic, so you can quickly locate the information you need to build, automate, and manage your Cargo workspace effectively.
