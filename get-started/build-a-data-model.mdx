...
**Setting up system of record:** Allow using existing warehouse instance as a system of record kept up to date by Cargo.

This framework ensures that Cargo users can effectively manage their data, offering a dynamic set of options for feeding data into plays.
