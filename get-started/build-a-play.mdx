...
Plays are automated workflows in Cargo that consume data from a Cargo data model to programmatically trigger at the right moment and execute a pre-defined workflow logic.
