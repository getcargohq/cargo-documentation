...
<CardGroup cols={2}>
  <Card title="Start with round robin" icon="arrows-rotate">
    Begin with simple even distribution, then add complexity as your routing
    needs evolve.
  </Card>
  <Card title="Set realistic capacity" icon="gauge">
    Base limits on your team's actual throughput—overloading reps hurts
    conversion rates.
  </Card>
  <Card title="Use fallback members" icon="life-ring">
    Always designate fallbacks so no lead ever goes unassigned.
  </Card>
  <Card title="Monitor allocation history" icon="clock-rotate-left">
    Regularly audit assignments to ensure rules work as expected.
  </Card>
</CardGroup>
