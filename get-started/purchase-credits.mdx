...
<iframe className="w-full aspect-video rounded-xl min-h-[700px]" src="https://www.getcargo.ai/pricing" title="Cargo Pricing Calculator" frameBorder="0" allow="clipboard-write; encrypted-media; picture-in-picture" allowFullScreen />
