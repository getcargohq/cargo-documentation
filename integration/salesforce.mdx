...
<CardGroup cols={2}>
  <Card title="Set up a Salesforce data model" icon="database">
    Create data models from your Salesforce objects to trigger Plays and power
    model search actions.
  </Card>
  <Card title="Use Salesforce in workflows" icon="diagram-project">
    Choose **Salesforce** from the node catalog within a **Play**, **Tool**, or
    **Agent**.
  </Card>
</CardGroup>
