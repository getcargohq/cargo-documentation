...
<CardGroup cols={2}>
  <Card title="Send messages from workflows" icon="message">
    Send notifications, alerts, and updates to Slack channels or users directly
    from your **Plays**, **Tools**, or **Agents**.
  </Card>
  <Card title="Keep teams informed" icon="bell">
    Automate real-time notifications for important events like new leads, deal
    updates, or workflow completions.
  </Card>
</CardGroup>
