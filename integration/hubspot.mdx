...
<CardGroup cols={2}>
  <Card title="Set up a HubSpot data model" icon="database">
    Create data models from your HubSpot objects to trigger Plays and power
    model search actions.
  </Card>
  <Card title="Use HubSpot in workflows" icon="diagram-project">
    Choose **HubSpot** from the node catalog within a **Play**, **Tool**, or
    **Agent**.
  </Card>
</CardGroup>
