...
<CardGroup cols={2}>
  <Card title="Set up an Attio data model" icon="database">
    Create data models from your Attio objects to trigger Plays and power model
    search actions. ![Attio data model](/images/attio_model.png)
  </Card>
  <Card title="Use Attio in workflows" icon="diagram-project">
    Choose **Attio** from the node catalog within a **Play**, **Tool**, or
    **Agent**. ![Attio catalog](/images/attio_catalog.png)
  </Card>
</CardGroup>
